...
> "Plan a 5-day trip to Dubai. $3,000 budget. Love food, architecture, and desert experiences, hate crowds."
...
- Travel logistics between areas
...
- Extracts key constraints:
  ...
  - **Duration:** 5 days
  - **Areas:** Downtown, Marina, Old Dubai, Desert
  - **Budget:** $3,000
  - **Preferences:** food, architecture, desert experiences
  - **Avoidances:** crowds
...
- Recommends neighborhoods, landmarks, food districts, and local experiences
- Suggests less-crowded options where possible
- Identifies "must-do" vs "nice-to-have" items

**Example output:**

- Best souks and heritage areas in Old Dubai
- Food neighborhoods in Downtown and Marina
- Off-peak or less-crowded experiences (e.g., desert safari timings, quieter beaches)
...
- Metro routes / taxi and ride-hailing info
- Maps / distance tools

**What it does:**

- Suggests where to stay (Downtown, Marina, Deira, etc.)
- Estimates travel time between areas
- Recommends how to move around Dubai (Metro, taxis, water taxis)
- Builds a realistic sequence for each day

**Example output:**

- 3 nights near Downtown, 2 nights at the Marina
- Dubai Metro and taxis between areas
- Day plans that reduce backtracking across the city
...
- Attraction pricing (Burj Khalifa, desert safari, etc.)
...
- Hotel cost too high in Downtown Dubai → suggest Deira or JBR area
...
- Does it cover key Dubai areas (Downtown, Marina, Old Dubai, Desert)?
- Is it within the $3,000 budget?
- Does it align with "food + architecture + desert experiences"?
